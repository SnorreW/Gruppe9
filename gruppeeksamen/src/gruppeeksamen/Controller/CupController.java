...
public class CupController {
    ...
    private void fyllListen(ListView<String> lagSomErMed, String cup) {
        ...
        listeMedLag.clear();
        listeMedLag = DataHandler.hentDataHele("src/gruppeeksamen/arrangementer.csv",listeMedLag);
    ...
    private void slettBestemtLagICup(String cup, String lagetSomSkalSlettes) {
        File filSomLesesFra = new File("src/gruppeeksamen/arrangementer.csv");
        String nyLag = "";
        String nyLagLinje = "";
        int antallLag;
        ...
        try {
            ...
            FileWriter skriv = new FileWriter("src/gruppeeksamen/arrangementer.csv");
